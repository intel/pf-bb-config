...
extern int
fpga_lte_parse_conf_file(const char *file_name,
		struct fpga_lte_fec_conf *fpga_conf);

/* Read 8-bit register of FPGA LTE FEC device */
static uint8_t
...
/* Read 16-bit register of FPGA LTE FEC device */
static uint16_t
...
/* Read 32-bit register of FPGA LTE FEC device */
static uint32_t
...
int
fpga_lte_configure(void *dev, void *bar0addr, const char *cfg_filename, const bool first_cfg)
{
	struct fpga_lte_fec_conf fpga_conf;
	int ret;
